					...
					<div class="block-car-info">
						...
						<div class="block-car-info-left">
							...
							<div class="comment-block">
								<h3>Comments & Bids</h3>
								<form id="comments-form-infile" disabled>
									<input type="hidden" value="" id="id_com_reply" style="display: none;">
									<label for="comm_tex_area" id="reply_text" style="display: block;">Re: some_person</label>
									<textarea id="ajax-textarea-infile-comments" placeholder="Add a comment..." name='comm_text_area'></textarea><br>
									<div class="button-block"><button type="button" id="ajax-submit-infile-comments" class="disabled"><img src="data:image/png;base64,"></button></div>
								</form>
